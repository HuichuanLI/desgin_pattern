...
namespace _nmsp2 {
    ...
    public:
        //实现导出动作
        void doExport(DailyHeaderData &dailyheaderobj, vector<DailyContentData *> &vec_dailycontobj,
                      DailyFooterData &dailyfooterobj) //记得#include头文件vector，因为日报的内容主体部分中的描述数据可能会有多条，所以用vector容器保存
        {
            string strtmp = "";
    ...
    public:
        ...
        //组装文件
        string Construct(DailyHeaderData &dailyheaderobj, vector<DailyContentData *> &vec_dailycontobj,
